...
public class GroupDoTaskListEngine extends BaseEngin {
    ...
    public Observable<ResultInfo<String>> getDoTaskList(String class_id, String user_id) {

        Map<String, String> params = new HashMap<>();
        params.put("class_id", class_id);
        params.put("user_id", user_id);
        return HttpCoreEngin.get(mContext).rxpost(NetConstan.list_do_task, new TypeReference<ResultInfo<String>>() {
