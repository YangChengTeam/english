...
public class UnionIssueTaskActivity extends FullScreenActivity<GroupTaskPublishPresenter> implements GroupTaskPublishContract.View {
    ...
    public void init() {
        ...
        mPresenter.getGroupList(this, uid, "1", "1");
    ...
    private void initListener() {
        ...
        mToolbar.setOnItemClickLisener(new BaseToolBar.OnItemClickLisener() {
            @Override
            public void onClick() {
                Intent intent = new Intent(UnionIssueTaskActivity.this, GroupPublishTaskListActivity.class);
        ...
        recyclerViewPicture.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    startActivityForResult(new Intent(UnionIssueTaskActivity.this, PictureSelectorActivity.class), 300);
                }
                return false;
            }
        });
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.m_rl_async_to_other:
                intent = new Intent(this, UnionSyncGroupListActivity.class);
            ...
            case R.id.m_ll_issue_file:
                intent = new Intent(UnionIssueTaskActivity.this, FileListActivity.class);
    ...
    private void audioRecord(View view) {
        ...
        AudioRecordManager.getInstance().setCallback(new AudioRecordManager.Callback() {
            ...
            public void onSuccess(File file, int duration) {
                ...
                mPresenter.uploadFile(UnionIssueTaskActivity.this, file, file.getPath().substring(file.getPath().lastIndexOf("/") + 1), "");
    ...
    private void restoreTaskData() {
        ...
        if (voiceList != null && voiceList.size() > 0) {
            for (Voice voice : voiceList) {
                mPresenter.uploadFile(UnionIssueTaskActivity.this, voice.getFile(), voice.getFile().getPath().substring(voice.getFile().getPath().lastIndexOf("/") + 1), "");
            }
        }
