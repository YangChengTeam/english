...
public class GlideCatchHelper {
    private static GlideCatchHelper instance;

    private String mCachePath;
    private Context mContext;

    public static GlideCatchHelper getInstance(Context context) {
        if (null == instance) {

            instance = new GlideCatchHelper(context);
        }
        return instance;
    }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(mCachePath, true);
    }
