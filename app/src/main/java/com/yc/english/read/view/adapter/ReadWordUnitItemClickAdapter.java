...
public class ReadWordUnitItemClickAdapter extends BaseMultiItemQuickAdapter<UnitInfo, BaseViewHolder> {

    private Context mContext;

    public ReadWordUnitItemClickAdapter(Context mContext, List<UnitInfo> data) {
        super(data);
