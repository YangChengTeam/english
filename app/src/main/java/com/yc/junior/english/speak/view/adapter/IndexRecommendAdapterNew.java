...
public class IndexRecommendAdapterNew extends RecyclerView.Adapter<IndexRecommendAdapterNew.MyViewHolder> {
    ...
    public IndexRecommendAdapterNew(Context context, List list, HashMap<NativeExpressADView, Integer> adViewPositionMap) {
