...
import com.yc.junior.english.main.contract.RegisterContract;
import com.yc.junior.english.main.hepler.UserInfoHelper;
import com.yc.junior.english.main.model.domain.Constant;
import com.yc.junior.english.main.model.domain.UserInfoWrapper;
import com.yc.junior.english.main.model.engin.RegisterEngin;
            ...
            public void onNext(final ResultInfo<UserInfoWrapper> resultInfo) {
                handleResultInfo(resultInfo, new Runnable() {
                    ...
                    public void run() {
                        ...
                        RxBus.get().post(Constant.COMMUNITY_ACTIVITY_REFRESH, "from getUserInfo");
                        mView.finish();
                    }
                });
            }
