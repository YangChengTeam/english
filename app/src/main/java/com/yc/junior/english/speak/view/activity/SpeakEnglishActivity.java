...
import com.yc.junior.english.read.view.wdigets.SpaceItemDecoration;
...
import com.yc.junior.english.speak.view.adapter.SpeakItemAdapter;
        ...
        public void onCompleted(SpeechError error) {
            if (error == null) {
                ...
                if (error.getErrorDescription().contains("权")) {
                    com.yc.junior.english.base.utils.SpeechUtils.resetAppid(SpeakEnglishActivity.this);
                    return;
                }
            }
        }
