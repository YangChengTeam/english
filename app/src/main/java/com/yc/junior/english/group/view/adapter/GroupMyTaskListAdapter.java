...
public class GroupMyTaskListAdapter extends BaseAdapter<TaskAllInfoWrapper.TaskAllInfo> {
    public GroupMyTaskListAdapter(Context context, List<TaskAllInfoWrapper.TaskAllInfo> mList) {
        super(context, mList);
    }
