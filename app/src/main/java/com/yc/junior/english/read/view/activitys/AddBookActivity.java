...
import com.yc.junior.english.read.presenter.AddBookPresenter;
import com.yc.junior.english.read.view.adapter.CourseVersionItemClickAdapter;
import com.yc.junior.english.read.view.adapter.GradeItemClickAdapter;
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                if (viewType == 1) {
                    ...
                    if (mGradeDatas != null) {
                        ...
                        mCourseVersionAdapter.getData().get(position).setSelected(true);
                        if (lastVersionPosition != position) {
                            lastVersionPosition = position;
                        }
                        mCourseVersionAdapter.notifyDataSetChanged();

                        CourseVersionInfo courseVersionInfo = mCourseVersionAdapter.getData().get(position);
