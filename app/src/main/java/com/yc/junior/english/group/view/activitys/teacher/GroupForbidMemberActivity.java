...
import com.yc.junior.english.group.contract.GroupGetForbidMemberContract;
import com.yc.junior.english.group.listener.OnCheckedChangeListener;
import com.yc.junior.english.group.model.bean.GroupInfoHelper;
import com.yc.junior.english.group.model.bean.StudentInfo;
import com.yc.junior.english.group.presenter.GroupGetForbidMemberPresenter;
import com.yc.junior.english.group.rong.models.GagGroupUser;
import com.yc.junior.english.group.view.adapter.GroupForbidMemberAdapter;
...
public class GroupForbidMemberActivity extends FullScreenActivity<GroupGetForbidMemberPresenter> implements GroupGetForbidMemberContract.View {
    ...
    private void getData() {
        mPresenter.getMemberList(GroupInfoHelper.getGroupInfo().getId(), 1, 500, "1", "", GroupInfoHelper.getClassInfo().getType());
    }
