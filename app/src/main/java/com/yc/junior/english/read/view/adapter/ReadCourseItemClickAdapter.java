    ...
    protected void convert(final BaseViewHolder helper, final EnglishCourseInfo item) {
        ...
        if (item.isPlay()) {
            ...
            if (helper.getAdapterPosition() == getLastPosition()) {
                ...
                helper.setGone(R.id.iv_speak_result, false);
                helper.setGone(R.id.tv_result_hint, false);
            }
        }
        ...
        if (helper.getAdapterPosition() == getLastPosition()) {
            helper.setGone(R.id.item_play_layout, true);
        } else {
            helper.setGone(R.id.item_play_layout, false);
        }

        switch (languageType) {
            case 1:
                helper.setGone(R.id.tv_chinese_title, true).setVisible(R.id.tv_english_title, true);
                break;
            case 2:
                helper.setGone(R.id.tv_chinese_title, false).setVisible(R.id.tv_english_title, true);
                break;
            case 3:
                helper.setGone(R.id.tv_chinese_title, true).setVisible(R.id.tv_english_title, false);
                break;
            default:
                break;
        }
