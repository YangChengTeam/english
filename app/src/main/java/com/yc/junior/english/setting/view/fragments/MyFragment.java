package com.yc.junior.english.setting.view.fragments;
...
import com.yc.junior.english.setting.view.activitys.CameraTaskActivity;
import com.yc.junior.english.setting.view.activitys.FeedbackActivity;
import com.yc.junior.english.setting.view.activitys.MyOrderActivity;
import com.yc.junior.english.setting.view.activitys.PersonCenterActivity;
import com.yc.junior.english.setting.view.activitys.SettingActivity;
import com.yc.junior.english.setting.view.activitys.VipEquitiesActivity;
import com.yc.junior.english.setting.view.popupwindows.FollowWeiXinPopupWindow;
import com.yc.junior.english.setting.view.widgets.MenuItemView;
...
public class MyFragment extends BaseFragment<MyPresenter> implements MyContract.View, QQqunDialog.QQqunClick {
    ...
    public void onResume() {
        ...
        if (UserInfoHelper.getUserInfo() != null && (UserInfoHelper.getUserInfo().getIsVip() == 1 || UserInfoHelper.getUserInfo().getIsVip() == 2 ||
                UserInfoHelper.getUserInfo().getIsVip() == 3 || UserInfoHelper.getUserInfo().getIsVip() == 4)) {
