 ...
 * On 2016/04/18 16:15
 */
public class XinQuVideoPlayerStandard extends XinQuVideoPlayer {
    ...
    public XinQuVideoPlayerStandard(Context context) {
        super(context);
    }

    public XinQuVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(XinQuUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (XinQuVideoPlayerManager.getFirstFloor().currentScreen == XinQuVideoPlayer.SCREEN_WINDOW_LIST) {
            ...
            onStatePreparing();
            onEvent(XinQuUserAction.ON_CLICK_START_ERROR);
        }
    }
