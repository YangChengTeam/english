 ...
 * 实现系统的播放引擎
 */
public class JZMediaNewSystem extends JZMediaInterface implements PLMediaPlayer.OnPreparedListener, PLMediaPlayer.OnCompletionListener, PLMediaPlayer.OnBufferingUpdateListener, PLMediaPlayer.OnSeekCompleteListener, PLMediaPlayer.OnErrorListener, PLMediaPlayer.OnInfoListener, PLMediaPlayer.OnVideoSizeChangedListener {

    private Context mContext;
    private PLMediaPlayer mediaPlayer;
    private long time;

    public JZMediaNewSystem(Context context) {
...
//            avOptions.setString(AVOptions.KEY_CACHE_DIR, Config.getDefaultCacheDir(mContext));
            ...
            mediaPlayer.setOnPreparedListener(JZMediaNewSystem.this);
            mediaPlayer.setOnCompletionListener(JZMediaNewSystem.this);
            mediaPlayer.setOnBufferingUpdateListener(JZMediaNewSystem.this);
            mediaPlayer.setScreenOnWhilePlaying(true);
            mediaPlayer.setOnSeekCompleteListener(JZMediaNewSystem.this);
            mediaPlayer.setOnErrorListener(JZMediaNewSystem.this);
            mediaPlayer.setOnInfoListener(JZMediaNewSystem.this);
            mediaPlayer.setOnVideoSizeChangedListener(JZMediaNewSystem.this);
